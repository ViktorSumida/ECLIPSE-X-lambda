...
if (graph == 1):
    ...
    epsilon_Rackham_ff_2 = np.genfromtxt("output_epsilon_Rackham(trans_lat=-46graus,f_spot=0.02).txt", delimiter=",")
    epsilon_Rackham_ff_4 = np.genfromtxt("output_epsilon_Rackham(trans_lat=-46graus,f_spot=0.04).txt", delimiter=",")
    epsilon_Rackham_ff_6 = np.genfromtxt("output_epsilon_Rackham(trans_lat=-46graus,f_spot=0.06).txt", delimiter=",")
    epsilon_Rackham_ff_8 = np.genfromtxt("output_epsilon_Rackham(trans_lat=-46graus,f_spot=0.08).txt", delimiter=",")
    epsilon_Rackham_ff_10 = np.genfromtxt("output_epsilon_Rackham(trans_lat=-46graus,f_spot=0.10).txt", delimiter=",")
    ...
    transit_depth_tl_46_ff_0 = np.genfromtxt("output_transit_depth(trans_lat=-46graus,f_spot=0.00).txt", delimiter=",")
    transit_depth_tl_46_ff_2 = np.genfromtxt("output_transit_depth(trans_lat=-46graus,f_spot=0.02).txt", delimiter=",")
    transit_depth_tl_46_ff_4 = np.genfromtxt("output_transit_depth(trans_lat=-46graus,f_spot=0.04).txt", delimiter=",")
    transit_depth_tl_46_ff_6 = np.genfromtxt("output_transit_depth(trans_lat=-46graus,f_spot=0.06).txt", delimiter=",")
    transit_depth_tl_46_ff_8 = np.genfromtxt("output_transit_depth(trans_lat=-46graus,f_spot=0.08).txt", delimiter=",")
    transit_depth_tl_46_ff_10 = np.genfromtxt("output_transit_depth(trans_lat=-46graus,f_spot=0.10).txt", delimiter=",")
    wavelengths = np.genfromtxt("output_wavelengths.txt", delimiter=",")
    ...
    transit_depth_phot_trans_lat_0 = np.genfromtxt("output_transit_depth(trans_lat=0graus,f_spot=0.00).txt", delimiter=",")
    transit_depth_phot_trans_lat_10 = np.genfromtxt("output_transit_depth(trans_lat=-9graus,f_spot=0.00).txt", delimiter=",")
    transit_depth_phot_trans_lat_20 = np.genfromtxt("output_transit_depth(trans_lat=-19graus,f_spot=0.00).txt", delimiter=",")
    transit_depth_phot_trans_lat_30 = np.genfromtxt("output_transit_depth(trans_lat=-30graus,f_spot=0.00).txt", delimiter=",")
    transit_depth_phot_trans_lat_40 = np.genfromtxt("output_transit_depth(trans_lat=-40graus,f_spot=0.00).txt", delimiter=",")
    transit_depth_phot_trans_lat_50 = np.genfromtxt("output_transit_depth(trans_lat=-50graus,f_spot=0.00).txt", delimiter=",")
    transit_depth_phot_trans_lat_60 = np.genfromtxt("output_transit_depth(trans_lat=-59graus,f_spot=0.00).txt", delimiter=",")
    transit_depth_phot_trans_lat_70 = np.genfromtxt("output_transit_depth(trans_lat=-69graus,f_spot=0.00).txt", delimiter=",")
    transit_depth_phot_trans_lat_80 = np.genfromtxt("output_transit_depth(trans_lat=-79graus,f_spot=0.00).txt", delimiter=",")
    wavelengths = np.genfromtxt("output_wavelengths.txt", delimiter=",")
    ...
    transit_depth_trans_lat_20_fspot_0 = np.genfromtxt("output_transit_depth(trans_lat=-19graus,f_spot=0.00).txt", delimiter=",")
    transit_depth_trans_lat_20_fspot_4 = np.genfromtxt("output_transit_depth(trans_lat=-19graus,f_spot=0.04).txt", delimiter=",")
    transit_depth_trans_lat_30_fspot_0 = np.genfromtxt("output_transit_depth(trans_lat=-30graus,f_spot=0.00).txt", delimiter=",")
    transit_depth_trans_lat_30_fspot_4 = np.genfromtxt("output_transit_depth(trans_lat=-30graus,f_spot=0.04).txt", delimiter=",")
    transit_depth_trans_lat_40_fspot_0 = np.genfromtxt("output_transit_depth(trans_lat=-40graus,f_spot=0.00).txt", delimiter=",")
    transit_depth_trans_lat_40_fspot_4 = np.genfromtxt("output_transit_depth(trans_lat=-40graus,f_spot=0.04).txt", delimiter=",")
    transit_depth_trans_lat_50_fspot_0 = np.genfromtxt("output_transit_depth(trans_lat=-50graus,f_spot=0.00).txt", delimiter=",")
    transit_depth_trans_lat_50_fspot_4 = np.genfromtxt("output_transit_depth(trans_lat=-50graus,f_spot=0.04).txt", delimiter=",")
    transit_depth_trans_lat_60_fspot_0 = np.genfromtxt("output_transit_depth(trans_lat=-59graus,f_spot=0.00).txt", delimiter=",")
    ...
    epsilon_Rackham_trans_lat_20_fspot_8 = np.genfromtxt("output_epsilon_Rackham(trans_lat=-46graus,f_spot=0.08).txt", delimiter=",")
